...
public class CourseController {
	...
	public CourseDTO registerStudent(@RequestParam("email") String email, @RequestParam("courseID") String courseID) {
	...
	public CourseDTO unregisterStudent(@RequestParam("email") String email, @RequestParam("courseID") String courseID) {
		Account account = accountRepository.findById(email).orElse(null);
		Student student = (Student) account.getUserRole();
		Course course = courseRepository.findById(courseID).orElse(null);
